...
public class HttpUtil {
     ...
     * @throws IOException
     */
    public static CloseableHttpResponse post(String url, String entityString, Map<String, String> headermap) throws IOException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        //创建一个HttpPost的请求对象
     ...
     */
    public static JSONObject getResponseJson(HttpResponse response) throws ParseException, IOException {
